  ...
  networks: {
    ...
    goerli: {
      provider: () => new HDWalletProvider({
        ...
        providerOrUrl: 'https://goerli.infura.io/v3/' + '4adff567c1b74855beac780489dad6c8',
        chainId: 5
      }),
      network_id: 5, // Ropsten's id
      gas: 5500000, // Gas sent with each transaction (default: ~6700000)
      //  3000000
      // gasPrice: 50e9, // 20 gwei (in wei) (default: 100 gwei)
    ...
    sepolia_testnet: {
      provider: function () {
        return new HDWalletProvider({
          mnemonic: "sick alarm hint bounce wide rapid country double toddler erosion labor fatigue",
          providerOrUrl: `https://sepolia.infura.io/v3/` + '4adff567c1b74855beac780489dad6c8',
          chainId: 11155111
        })
      },
      network_id: 11155111,
